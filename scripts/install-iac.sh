...
TERRAFORM_VERSION="${ISK_TERRAFORM_VERSION:-1.16.0}"
OPENTOFU_VERSION="${ISK_OPENTOFU_VERSION:-1.12.6}"
KUBECTL_VERSION="${ISK_KUBECTL_VERSION:-1.37.0}"
HELM_VERSION="${ISK_HELM_VERSION:-4.2.4}"
