...
log "provisioning: pulumi=${ISK_PULUMI_VERSION:-3.260.0} terraform=${ISK_TERRAFORM_VERSION:-1.16.0} opentofu=${ISK_OPENTOFU_VERSION:-1.12.6} clouds=${ISK_INSTALL_CLOUDS:-1} dotnet=${ISK_INSTALL_DOTNET:-0}"
